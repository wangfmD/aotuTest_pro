...
from model.baseActionAdd import user_login, \
    add_cfg_hdks
from model.baseActionDel import del_cfg_hdks
# from model.baseActionModify import
from model.baseActionSearch import search_cfg_hdks
from model.baseActionModify import update_InteractiveTeaching
...
interactiveTeachingData = [{'name': u'720PP','searchName':u'互动课模板'}]
