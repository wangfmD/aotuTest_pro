...
def add_tenants(driver, **kwargs):
    ...
    try:
        ...
        driver.find_element_by_xpath("//*[@id='treeviews']/div/div/div[2]/button[1]").click()
        sleep(1)
        ...
        driver.find_element_by_css_selector("#platmarkName > div.col-sm-9 > input.form-control").send_keys(kwargs["platmarkName"])
        ...
        driver.find_element_by_css_selector("#platmarkCode > div.col-sm-9 > input.form-control").send_keys(kwargs["platmarkCode"])
...
classromms = [{'className': '31className', 'classAccNumber': '1'},
...
integrateds = [{'className': '32className', 'equipment_name': '81lb', 'ipAddr': '10.1.0.81', 'locAddr': '10.1.0.81', 'equipmentLogName': 'admin', 'equipmentLogPwd': 'admin'},
               {'className': '31className', 'equipment_name': '82lb', 'ipAddr': '10.1.0.82', 'locAddr': '10.1.0.81', 'equipmentLogName': 'admin', 'equipmentLogPwd': 'admin'}]

terminals = [
    {'equipmentModel': u'Group系列', 'className': '32className', 'equipment_name': '81lb', 'ipAddr': '10.1.0.81', 'locAddr': '10.1.0.81', 'equipmentLogName': 'admin', 'equipmentLogPwd': 'admin'},
    {'equipmentModel': u'Group系列', 'className': '31className', 'equipment_name': '82lb', 'ipAddr': '10.1.0.82', 'locAddr': '10.1.0.81', 'equipmentLogName': 'admin', 'equipmentLogPwd': 'admin'}]
...
def add_terminals(driver, **kwargs):
    ...
    '''添加一个终端'''
    print "add info:{0},{1}".format(kwargs['equipment_name'], kwargs['className'])
    # refresh main page
    try:
        driver.refresh()
...
roles = [{'roleName': 'a2role19', 'roleCode': '000', 'description': 'comment role'},
         {'roleName': 'a2role11', 'roleCode': '000', 'description': 'comment role'},
         {'roleName': 'a2role31', 'roleCode': '000', 'description': 'comment role'},
         {'roleName': 'a2role41', 'roleCode': '000', 'description': 'comment role'},
         {'roleName': 'a2role21', 'roleCode': '000', 'description': 'comment role'},
         {'roleName': 'arole51', 'roleCode': '000', 'description': 'comment role'},
         {'roleName': 'a2role61', 'roleCode': '000', 'description': 'comment role'},
         {'roleName': 'a2role71', 'roleCode': '000', 'description': 'comment role'}]
...
def add_sections(driver, **kwargs):
    ...
    try:
        ...
        driver.find_element_by_xpath("//input[@id='sectionName']").send_keys(kwargs['sectionName'])
        driver.find_element_by_xpath("//input[@id='sectionCode']").clear()
        driver.find_element_by_xpath("//input[@id='sectionCode']").send_keys(kwargs['sectionCode'])
        # click 确定
...
def conf_drivers_local(driver):
    ...
    driver.find_element_by_xpath("//table[@id='middlewaretable']/tbody/tr/td[2]").click()
    sleep(1)
    driver.find_element_by_css_selector("i.fa.fa-server").click()
    sleep(1)
    driver.find_element_by_name("ckrelevmcuid").click()
...
def conf_child_interact(driver, interactaddr, serveraddr):
    ...
    sleep(1)
    firstIpPageText = driver.find_element_by_xpath("//tbody[@id='selectLocal']/tr/td ").text
    secondIpPageText = driver.find_element_by_xpath("//tbody[@id='selectLocal']/tr[2]/td").text
    ...
    if firstIpPageText == serveraddr:
        ...
        driver.switch_to_alert().accept()
        sleep(1)
        driver.find_element_by_xpath("//tbody[@id='localQuery']/tr[2]/th[8]/button[4]").click()
        sleep(3)
        driver.switch_to_alert().accept()
        sleep(1)
        driver.find_element_by_xpath("//tbody[@id='localQuery']/tr[2]/th[8]/button[2]").click()
        sleep(3)
        driver.switch_to_alert().accept()
        sleep(4)
