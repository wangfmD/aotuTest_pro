...
def del_model(driver, **kwargs):
    ...
    sleep(0.5)
    driver.find_element_by_xpath("//td[6]/button[2]").click()
    sleep(0.5)
    driver.find_element_by_xpath("//div[8]/div[3]/a").click()

def del_live(driver, **kwargs):
    '''删除直播管理'''
    driver.refresh()
    driver.find_element_by_link_text(u"网站管理").click()
    sleep(0.5)
    ...
    driver.find_element_by_xpath("//td[11]/button[3]").click()
    driver.find_element_by_xpath("//div[17]/div[3]/a").click()
