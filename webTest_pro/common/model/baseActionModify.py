...
def update_announcement(driver, **kwargs):
    ...
    sleep(0.5)
    driver.find_element_by_xpath("//td[6]/a/i").click()
    sleep(0.5)
    driver.find_element_by_id("edit_title").clear()
    driver.find_element_by_id("edit_title").send_keys(kwargs["add_title"])
    sleep(0.5)
    driver.find_element_by_id("edit_sure").click() 
...
def update_column(driver, **kwargs):
    driver.refresh()
    driver.find_element_by_link_text(u"网站管理").click()
    sleep(0.5)
    ...
    driver.find_element_by_id("searchBtn").click()
    sleep(0.5)
    driver.find_element_by_xpath("//tbody[@id='datalists']/tr/td[6]/a").click()
    sleep(0.5)
    driver.find_element_by_id("navigationName_edit").clear()
    driver.find_element_by_id("navigationName_edit").send_keys(kwargs["navigationName_add"])
    driver.find_element_by_id("url_edit").clear()
    driver.find_element_by_id("url_edit").send_keys(kwargs["url_add"])
    Select(driver.find_element_by_id("navTypeEdit")).select_by_visible_text(kwargs["navTypeAdd"])
    driver.find_element_by_id("sort_edit").clear()
    driver.find_element_by_id("sort_edit").send_keys(kwargs["sort_add"])
    driver.find_element_by_id("remark_edit").clear()
    driver.find_element_by_id("remark_edit").send_keys(kwargs["remark_add"])
    driver.find_element_by_xpath("//div[5]/div/div/form/div/div[6]/button").click()
    
def update_model(driver, **kwargs):
    driver.refresh()
    driver.find_element_by_link_text(u"网站管理").click()
    sleep(0.5)
    driver.find_element_by_link_text(u"模板管理").click()
    ...
    sleep(0.5)
    driver.find_element_by_xpath("//td[6]/button").click()
    sleep(0.5)
    driver.find_element_by_xpath("//input[@name='updatename']").clear()
    driver.find_element_by_xpath("//input[@name='updatename']").send_keys(kwargs["addname"])
    driver.find_element_by_xpath("//input[@name='updateurl']").clear()
    driver.find_element_by_xpath("//input[@name='updateurl']").send_keys(kwargs["addurl"])
    driver.find_element_by_xpath("//input[@name='updateremark']").clear()
    driver.find_element_by_xpath("//input[@name='updateremark']").send_keys(kwargs["addremark"])
    Select(driver.find_element_by_id("updatenId")).select_by_visible_text(kwargs["addnId"])
    
    driver.find_element_by_xpath("//div[4]/div/div/form/div/div[6]/button").click()
    
def update_live(driver, **kwargs):
    '''修改直播管理'''
    driver.refresh()
    driver.find_element_by_link_text(u"网站管理").click()
    sleep(0.5)
    ...
    driver.find_element_by_xpath("//td[11]/button[2]").click()
    sleep(1)
...
if __name__ == "__main__":
    ...
    for terminal in columnData:
        update_column(driver, ** terminal)
